Vagrant.configure("2") do |config|
  ...
  # config.vm.provision "file",
  #   source:      "Provisions-Files/project/python/MinIO/data/table_dev1.csv",
  #   destination: "/home/vagrant/project/python/MinIO/data/table_dev1.csv"
  # config.vm.provision "file",
  #   source:      "Provisions-Files/project/python/MinIO/data/table.csv",
  #   destination: "/home/vagrant/project/python/MinIO/data/table.csv"
  config.vm.provision "file",
