...
def main():
    ...
    loader = MinIOLoader()
    loader.upload_dataframe(customers_df, "customers")
    loader.upload_dataframe(products_df,  "products")
    loader.upload_dataframe(orders_df,    "orders", partition_cols=["year", "month"])
